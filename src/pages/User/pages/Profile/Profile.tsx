        ...
        <form className='mt-6 flex-grow md:mt-0 md:pr-12'>
          ...
          <div className='flex flex-col flex-wrap sm:flex-row'>
            ...
            <div className='sm:w-[80%] sm:pl-5'>
              <div className='pt-3 text-gray-700'>hu************@gmail.com</div>
            </div>
          </div>
          {/* row item name*/}
          ...
          <div className='mt-2 flex flex-col flex-wrap sm:flex-row'>
            ...
            <div className='sm:w-[80%] sm:pl-5'>
              <div className='flex justify-between'>
                <select className='h-10 w-[32%] rounded-none border border-b-black/10 px-3 '>
        ...
        <div className='md-border-l flex justify-center md:w-72 md:border-l-gray-200'>
          <div className='flex flex-col items-center'>
            <div className='my-5 h-24 w-24'>
              <img
                src='https://down-vn.img.susercontent.com/file/50c250b017cddb586ae3997a68225a87_tn'
                alt=''
                className='h-full w-full rounded-full object-cover'
              />
            </div>
            <input className='hidden' type='file' accept='.jpg,.jpeg,.png'></input>
            <button className='flex h-10 items-center  rounded-sm border bg-white px-6 text-sm text-gray-600 shadow-sm'>
              Chọn ảnh
            </button>
